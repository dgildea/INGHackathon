...
- (void)viewDidLoad
{
    ...
    _menuItems = @[@"title", @"market", @"sell", @"bought", @"favourites", @"tag", @"logout"];
...
- (void) prepareForSegue: (UIStoryboardSegue *) segue sender: (id) sender
{
    if ([segue.identifier isEqualToString:@"logout"]) {
        UIAlertView *errorAlert = [[UIAlertView alloc] initWithTitle:@"Logout"
                                                             message:@"You are now Logged out of ING Market Place!"
                                                            delegate:nil
